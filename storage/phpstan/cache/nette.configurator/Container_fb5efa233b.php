...
// source: phar:///home/dan/Desktop/08/apache-htmx/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon
...
class Container_fb5efa233b extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_fb5efa233b $container)
			{
	...
	{
		return new PHPStan\Rules\Functions\ArrayFilterStrictRule($this->getService('reflectionProvider'), true, false, true);
	}
	...
	public function createServiceContainer(): Container_fb5efa233b
	{
		return $this;
	}
