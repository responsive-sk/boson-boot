...
>
    ...
    <svg class="logo-svg" viewBox="0 0 255 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <!-- Boson logo paths would go here -->
        <!-- For now, using a placeholder -->
        <rect x="10" y="20" width="60" height="60" fill="var(--color-text-brand, #F93904)" rx="8"/>
        <text x="80" y="45" fill="var(--color-text, #fff)" font-family="var(--font-title)" font-size="24" font-weight="600">
            Boson
        </text>
        <text x="80" y="65" fill="var(--color-text-secondary, rgba(255,255,255,0.6))" font-family="var(--font-body)" font-size="12">
            PHP Desktop
        </text>
    </svg>
